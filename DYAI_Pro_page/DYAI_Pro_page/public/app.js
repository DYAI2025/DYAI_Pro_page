                        ...
                        <div class="hidden md:flex items-center space-x-2">
                            ${navLinks
                              .map(
                                ...
                                <a href="${
                                  link.href
                                }" class="font-sans-custom font-medium px-4 py-2 rounded-md transition-colors duration-300 ${
                    ...
                    <div class="px-2 pt-2 pb-3 space-y-1">
                        ${navLinks
                          .map(
                            ...
                            <a href="${
                              link.href
                            }" class="block font-sans-custom font-medium px-3 py-2 rounded-md ${
                              currentPage === link.href
                                ? "bg-living-coral/10 text-living-coral"
                                : "text-structure-grey hover:bg-gray-100"
                            }">
                                ${link.text}
                            </a>
                        `
  ...
  initNavigation() {
    ...
    if (menuButton && navMenu) {
      menuButton.addEventListener("click", () => {
        ...
        icon.setAttribute(
          "data-lucide",
          navMenu.classList.contains("hidden") ? "menu" : "x"
        );
        lucide.createIcons();
      });
    }
